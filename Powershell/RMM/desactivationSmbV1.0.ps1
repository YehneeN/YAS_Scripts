...
if ($SMB1Status.State -eq "Enabled") {
    ...
    if ($resultDisable.RestartNeeded -eq $true) {
        ...
        function Open-MainForm {
            ...
            $ButtonPostpone1Hour.Text = 'Redémarrer dans 1 heure (forcé)'
            ...
            $labelITSystemsMaintenance.Text = 'Message de maintenance'
            ...
            $labelSecondsLeftToRestart.Text = 'Temps restant :'
            ...
            $labelInOrderToApplySecuri.Text = 'Afin de finaliser la désactivation du protocole obsolète SMB v1.0, votre ordinateur doit être redémarré.

Veuillez sauvegarder tous vos fichiers maintenant pour éviter toute perte de données.'
